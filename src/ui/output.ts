...
export function formatHelp(): string {
  return [
    ...
    cmd("sacc antigravity <account> [args]", "run Antigravity (agy) with account"),
    ...
    cmd("sacc antigravity login <name>", "sign in Antigravity into a profile"),
    ...
    cmd("sacc antigravity list", "list Antigravity accounts"),
    ...
    cmd("sacc antigravity rename|remove ...", "manage Antigravity profiles"),
    "",
    heading("Status"),
    cmd("sacc codex status <name>", "unified usage (5h / weekly / monthly)"),
    cmd("sacc grok status <name>", "unified usage (5h / weekly / monthly)"),
    cmd("sacc antigravity status <name>", "not exposed by the CLI (best effort)"),
